...
<div class="detail-view">
    ...
    <a id="tab{{$tabCount}}" data-toggle="tab" onclick="{{if isset($tabDefs[$label_upper].tabFunction)}}{{$tabDefs[$label_upper].tabFunction}}{{/if}}" class="{{if isset($tabDefs[$label_upper].tabClass)}}{{$tabDefs[$label_upper].tabClass}}{{/if}}">
                {sugar_translate label='{{$label}}' module='{{$module}}'}
            </a>
        </li>
        {{/if}}
