...
<div id="EditView_tabs">
    ...
    <ul class="nav nav-tabs">
        ...
        <li role="presentation" class="active">
            <a id="tab{{$tabCount}}" data-toggle="tab" class="hidden-xs {* //HACK *}{{if isset($tabDefs[$label_upper].panelClass)}}{{$tabDefs[$label_upper].panelClass}}{{/if}}{* //ENDHACK *}">
            ...
            *}
            ...
            <ul id="first-tab-menu-xs" class="dropdown-menu">
                ...
                <li role="presentation">
                    <a id="tab{{$tabCountXS}}" class="{* //HACK *}{{if isset($tabDefs[$label_upper].panelClass)}}{{$tabDefs[$label_upper].panelClass}}{{/if}}{* //ENDHACK *}" data-toggle="tab" onclick="changeFirstTab(this, 'tab-content-{{$tabCountXS}}');">
                        {sugar_translate label='{{$label}}' module='{{$module}}'}
                    </a>
                </li>
        ...
        <li role="presentation" class="hidden-xs">
            <a id="tab{{$tabCount}}" class="{* //HACK *}{{if isset($tabDefs[$label_upper].panelClass)}}{{$tabDefs[$label_upper].panelClass}}{{/if}}{* //ENDHACK *}"  data-toggle="tab">
                {sugar_translate label='{{$label}}' module='{{$module}}'}
            </a>
        </li>
        {{/if}}
    ...
    <div class="tab-content">
        ...
        <div class="panel-content">
            ...
            {{if $useTabs}}
                 {{if $tabCount == 0}}
                     <div class="panel panel-default tab-panel-{{$tabCount}} {* //HACK *}{{if isset($tabDefs[$label_upper].panelClass)}}{{$tabDefs[$label_upper].panelClass}}{{/if}}{* //ENDHACK *}" style="display: block;">
                 {{else}}
                     <div class="panel panel-default tab-panel-{{$tabCount}} {* //HACK *}{{if isset($tabDefs[$label_upper].panelClass)}}{{$tabDefs[$label_upper].panelClass}}{{/if}}{* //ENDHACK *}" style="display: none;">
                 {{/if}}
            {{else}}
              <div class="panel panel-default {* //HACK *}{{if isset($tabDefs[$label_upper].panelClass)}}{{$tabDefs[$label_upper].panelClass}}{{/if}}{* //ENDHACK *}">
            {{/if}}
